...
class LinearOpsTest(parameterized.TestCase):
    ...
    def testLinearOps_Dsd(self, m, k, n, trans_a, trans_b, blocking, sparsity):
        ...
        # Execute the matmul.
        out = _with_transpose(triton_matmul.dsd, a, b, trans_a, trans_b) 
    ...
    def testLinearOps_Dds(self, m, k, n, trans_a, trans_b, blocking, sparsity):
        ...
        # Execute the matmul.
        out = _with_transpose(triton_matmul.dds, a, b, trans_a, trans_b)
    ...
    def testLinearOps_Sdd(self, m, k, n, trans_a, trans_b, blocking, sparsity):
        ...
        # Execute the matmul.
        out = _sparse_out_with_transpose(triton_matmul.sdd, a, b, topo, trans_a, trans_b)
